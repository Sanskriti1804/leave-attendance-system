...
- Base path: `/api/v1`. Implemented so far: auth, departments, employees, holidays, org-settings, leaves, documents, leave-policies, leave-types, notifications, audit list, reports (see [auth-and-employees](auth-and-employees.md), [leave](leave.md), [reports-notifications-audit](reports-notifications-audit.md)).

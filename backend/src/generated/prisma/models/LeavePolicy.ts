...
export type LeavePolicyCountAggregateOutputType = {
  policyId: number
  leaveTypeId: number
  medicalDocumentAfterDays: number
...
export type LeavePolicyWhereInput = {
  ...
  policyId?: Prisma.IntFilter<"LeavePolicy"> | number
  leaveTypeId?: Prisma.IntFilter<"LeavePolicy"> | number
  medicalDocumentAfterDays?: Prisma.IntNullableFilter<"LeavePolicy"> | number | null
  includeWeekends?: Prisma.BoolFilter<"LeavePolicy"> | boolean
...
export type LeavePolicyOrderByWithRelationInput = {
  ...
  medicalDocumentAfterDays?: Prisma.SortOrderInput | Prisma.SortOrder
  includeWeekends?: Prisma.SortOrder
...
export type LeavePolicyScalarWhereWithAggregatesInput = {
  ...
  policyId?: Prisma.IntWithAggregatesFilter<"LeavePolicy"> | number
  leaveTypeId?: Prisma.IntWithAggregatesFilter<"LeavePolicy"> | number
  medicalDocumentAfterDays?: Prisma.IntNullableWithAggregatesFilter<"LeavePolicy"> | number | null
  includeWeekends?: Prisma.BoolWithAggregatesFilter<"LeavePolicy"> | boolean
...
export type LeavePolicyUpdateInput = {
  medicalDocumentAfterDays?: Prisma.NullableIntFieldUpdateOperationsInput | number | null
  includeWeekends?: Prisma.BoolFieldUpdateOperationsInput | boolean
...
export type LeavePolicyCountOrderByAggregateInput = {
  policyId?: Prisma.SortOrder
  leaveTypeId?: Prisma.SortOrder
  medicalDocumentAfterDays?: Prisma.SortOrder
  includeWeekends?: Prisma.SortOrder
  includeHolidays?: Prisma.SortOrder
...
export type LeavePolicySelect<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetSelect<{
  policyId?: boolean
  leaveTypeId?: boolean
  medicalDocumentAfterDays?: boolean
  includeWeekends?: boolean
  includeHolidays?: boolean
  maxDays?: boolean
  obsolete?: boolean
...
export interface LeavePolicyDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const leavePolicyWithPolicyIdOnly = await prisma.leavePolicy.findMany({ select: { policyId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many LeavePolicies and only return the `policyId`
   * const leavePolicyWithPolicyIdOnly = await prisma.leavePolicy.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more LeavePolicies and only return the `policyId`
   * const leavePolicyWithPolicyIdOnly = await prisma.leavePolicy.updateManyAndReturn({
   *   select: { policyId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface LeavePolicyFieldRefs {
  readonly policyId: Prisma.FieldRef<"LeavePolicy", 'Int'>
  readonly leaveTypeId: Prisma.FieldRef<"LeavePolicy", 'Int'>
  readonly medicalDocumentAfterDays: Prisma.FieldRef<"LeavePolicy", 'Int'>
  readonly includeWeekends: Prisma.FieldRef<"LeavePolicy", 'Boolean'>

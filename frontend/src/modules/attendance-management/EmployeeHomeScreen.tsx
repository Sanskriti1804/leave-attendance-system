...
// Design System Tokens matching LAMS SCG Tailwind Configuration
const colors = {
  surface: "#fcf9f8",
...
export default function EmployeeHomeScreen() {
  ...
  const attendanceHref = "/attendance";
  const correctionsHref = "/attendance-corrections";

  const [, setMe] = useState<EmployeePublic | null>(null);
  const [, setSettings] = useState<OrganisationSettings | null>(null);
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.header}>
        <View style={styles.headerBrand}>
          <View style={styles.brandBadge}>
            <Text style={styles.brandBadgeText}>SCG</Text>
          </View>
      ...
      >
        {/* Live IST Server Clock & Date Banner */}
        ...
        {/* Shift Simulation Mode Switcher */}

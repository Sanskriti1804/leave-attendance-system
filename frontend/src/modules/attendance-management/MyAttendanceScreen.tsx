    ...
    <SafeAreaView style={styles.safeArea} edges={["bottom"]}>
      ...
      <ScrollView contentContainerStyle={[styles.content, { paddingTop: topInset }]} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.monthCard}>
          <TouchableOpacity style={styles.monthCenter} onPress={() => setMonthOpen((open) => !open)} accessibilityLabel="Select month">
          ...
          {monthOpen ? (
            <View style={styles.monthMenu}>
              {monthOptions.map((option) => (
                ...
                >
                  <Text style={styles.monthTitle}>{monthTitle(option)}</Text>
                </TouchableOpacity>
              ))}
            </View>
          ) : null}
...
const styles = StyleSheet.create({
  safeArea: { flex: 1, backgroundColor: colors.surface }, content: { padding: 16, paddingBottom: 36, gap: 12 }, topRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" }, iconButton: { width: 44, height: 44, alignItems: "center", justifyContent: "center", borderRadius: 8 }, brand: { width: 28, height: 28, borderRadius: 6, backgroundColor: colors.primary, alignItems: "center", justifyContent: "center" }, brandText: { color: colors.onPrimary, fontWeight: "700", fontSize: 11 }, title: { fontSize: 22, fontWeight: "600", color: colors.text }, monthCard: { backgroundColor: colors.low, borderRadius: 12, padding: 10, gap: 8 }, monthCenter: { alignItems: "center", gap: 2 }, monthMenu: { gap: 8, paddingTop: 4 }, monthTitleRow: { flexDirection: "row", alignItems: "center", gap: 4 }, monthTitle: { fontSize: 14, fontWeight: "600", color: colors.text }, monthMeta: { fontSize: 11, color: colors.secondary }, metricGrid: { flexDirection: "row", gap: 8 }, metric: { flex: 1, minHeight: 82, padding: 12, borderRadius: 12, backgroundColor: colors.card, justifyContent: "space-between", borderWidth: 1, borderColor: colors.glassBorder }, metricLabel: { fontSize: 10, fontWeight: "700", color: colors.secondary, textTransform: "uppercase" }, metricValueRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between" }, metricValue: { fontSize: 21, fontWeight: "600", color: colors.text, fontVariant: ["tabular-nums"] }, rangeCard: { padding: 12, borderRadius: 12, backgroundColor: colors.card, flexDirection: "row", gap: 7, alignItems: "center", borderWidth: 1, borderColor: colors.glassBorder }, rangeText: { color: colors.secondary, fontSize: 12 }, filterRow: { gap: 8, paddingVertical: 2 }, filter: { height: 32, paddingHorizontal: 12, borderRadius: 999, backgroundColor: colors.card, justifyContent: "center", borderWidth: 1, borderColor: colors.glassBorder }, filterActive: { backgroundColor: colors.primary }, filterText: { fontSize: 10, fontWeight: "700", color: colors.text, textTransform: "uppercase" }, filterTextActive: { color: colors.onPrimary }, loader: { marginVertical: 28 }, error: { color: colors.error, padding: 12, backgroundColor: colors.surfaceContainerLow, borderRadius: 12 }, empty: { color: colors.secondary, textAlign: "center", paddingVertical: 28 }, record: { backgroundColor: colors.card, borderRadius: 12, padding: 14, gap: 8, borderWidth: 1, borderColor: colors.glassBorder }, restRecord: { backgroundColor: colors.low }, recordTop: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" }, recordTitleRow: { flexDirection: "row", alignItems: "center", gap: 8, flexShrink: 1 }, recordDate: { color: colors.text, fontWeight: "600", fontSize: 14 }, statusPill: { backgroundColor: colors.high, borderRadius: 999, paddingHorizontal: 8, paddingVertical: 3 }, statusPillText: { color: colors.text, fontSize: 9, fontWeight: "700" }, duration: { fontSize: 14, fontWeight: "600", color: colors.text }, recordBottom: { flexDirection: "row", justifyContent: "space-between", gap: 8, alignItems: "center" }, timeRow: { flexDirection: "row", alignItems: "center", gap: 3, flex: 1 }, recordMeta: { color: colors.secondary, fontSize: 11 }, arrow: { color: colors.secondary, marginHorizontal: 2 }, pagination: { alignItems: "center", gap: 8, paddingTop: 4 }, pageRow: { flexDirection: "row", alignItems: "center", gap: 16 }, pageButton: { width: 44, height: 40, borderRadius: 12, backgroundColor: colors.low, alignItems: "center", justifyContent: "center" }, pageText: { color: colors.text, fontSize: 12, fontWeight: "600" }, loaded: { color: colors.secondary, fontSize: 10, fontWeight: "700", textTransform: "uppercase" }, disabled: { opacity: 0.4 }, backdrop: { flex: 1, backgroundColor: "rgba(0,0,0,0.4)", justifyContent: "flex-end" }, sheet: { backgroundColor: colors.card, borderTopLeftRadius: 16, borderTopRightRadius: 16, padding: 16, gap: 12 }, handle: { alignSelf: "center", width: 40, height: 4, borderRadius: 2, backgroundColor: colors.high }, sheetHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" }, eyebrow: { color: colors.secondary, fontSize: 10, fontWeight: "700" }, sheetTitle: { color: colors.text, fontSize: 17, fontWeight: "600" }, detailStatus: { padding: 12, backgroundColor: colors.low, borderRadius: 8, gap: 4 }, detailStatusText: { color: colors.text, fontSize: 14, fontWeight: "600" }, detailRow: { flexDirection: "row", justifyContent: "space-between", gap: 16, paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: colors.container }, detailLabel: { color: colors.secondary, fontSize: 12 }, detailValue: { color: colors.text, fontSize: 12, fontWeight: "600", textAlign: "right", flexShrink: 1 }, closeButton: { height: 48, backgroundColor: colors.low, borderRadius: 12, alignItems: "center", justifyContent: "center", marginTop: 4 }, closeButtonText: { color: colors.text, fontSize: 14, fontWeight: "600" },
});

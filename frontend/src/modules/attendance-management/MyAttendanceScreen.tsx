...
export default function MyAttendanceScreen() {
  ...
  function changeMonth(delta: number) {
    setMonth((current: string) => shiftMonth(current, delta));
    setPage(1);
  }

...
const styles = StyleSheet.create({
  ...
  brand: { fontSize: 15, fontWeight: "700", letterSpacing: 1.6, color: colors.onSurface, textTransform: "uppercase" },
  brandSub: { fontSize: 12, color: colors.secondary, marginBottom: 16 },
  navList: { gap: 6 },
  ...
  canvas: { width: "100%", maxWidth: 1120, alignSelf: "center", gap: 18 },
  card: {

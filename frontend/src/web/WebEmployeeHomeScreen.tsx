...
const styles = StyleSheet.create({
  ...
  punch: { flex: 1, flexBasis: 0, minWidth: 240, minHeight: 168 },
  ...
  metric: { flex: 1, flexBasis: 0, minWidth: 180, minHeight: 132 },
  metricVal: { fontSize: 22, fontWeight: "700", color: colors.onSurface, marginTop: 6 },
  actions: { flexDirection: "row", flexWrap: "wrap", gap: 16 },
  action: { flex: 1, flexBasis: 0, minWidth: 220, minHeight: 96, backgroundColor: colors.surfaceContainerLowest, borderRadius: 10, padding: 16, borderWidth: 1, borderColor: colors.glassBorder, borderLeftWidth: 3, borderLeftColor: colors.accent, justifyContent: "center" },

...
const styles = StyleSheet.create({
  ...
  input: { borderWidth: 1, borderColor: colors.border, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 10, color: colors.onSurface, marginTop: 4, backgroundColor: colors.surfaceContainerLow },
  ...
  submit: { marginTop: 12, backgroundColor: colors.accent, borderRadius: 8, paddingVertical: 12, alignItems: "center" },
